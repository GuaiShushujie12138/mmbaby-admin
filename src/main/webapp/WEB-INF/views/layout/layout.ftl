<#macro layout context={} nav=true mainWrap=true header=true >
    <#include "../lib/lib.ftl">
    <#assign BASEPATH=context.staticUrl>
    <#assign APPBASEURL=context.appBaseUrl>
    <#assign VERSION=context.clientVersion>
    <#assign title=context.title!"SSO Portal">
    <#assign release = context.release>
    <#assign extraLoadCss=(context.extraLoadCss![])>
    <#assign extraLoadCssPlugin=(context.extraLoadCssPlugin![])>
    <#assign extraLoadJS=(context.extraLoadJS![])>
    <#assign extraLoadJSPlugin=(context.extraLoadJSPlugin![])>
    <#assign location = (context.location!"")>
    <#assign headerBlock = (context.headerBlock!"")>
    <#assign footerBlock = (context.footerBlock!"")>
    <#assign bodyAdditionCss = (context.bodyAdditionCss!"")>
    <#assign isShowNavBar = (context.isShowNavBar!true)>
    <#assign user = (context.user!{})>
    <#assign copyright = '2016 &copy; 怪蜀黍科技有限公司.'>
<!DOCTYPE html>
...
<head>
    ...
    <link href="${BASEPATH}/assets/global/plugins/bootstrap-switch/css/bootstrap-switch.min.css" rel="stylesheet"
          type="text/css"/>
    <link rel="stylesheet" type="text/css" href="${BASEPATH}/assets/global/plugins/bootstrap-toastr/toastr.min.css"/>
    <!-- END GLOBAL MANDATORY STYLES -->
    <!-- BEGIN PAGE LEVEL PLUGINS -->
    <@utils.cssLinks base=BASEPATH version=VERSION cssLinks=extraLoadCssPlugin isPlugin=true />
    ...
    <@utils.cssLinks base=BASEPATH version=VERSION cssLinks=extraLoadCss isPlugin=false/>
    <!-- END PAGE LEVEL STYLES -->
    <!-- BEGIN THEME LAYOUT STYLES -->
    <link href="${BASEPATH}/assets/layouts/layout/css/layout.min.css" rel="stylesheet" type="text/css"/>
    <link href="${BASEPATH}/assets/layouts/layout/css/themes/darkblue.min.css" rel="stylesheet" type="text/css"
          id="style_color"/>
...
${headerBlock}
    ...
    <style type="text/css">
        body {
            font-family: "open sans", "Helvetica Neue", "Helvetica", "Arial", "Microsoft YaHei", "黑体", "宋体", sans-serif;
        "
        }
        ...
        .page-header.navbar .page-logo .logo-default {
            ...
            <#if isShowNavBar==false>
            .page-content-wrapper .page-content {
                margin-left: 0px;
            }
            </#if>
    </style>
    <link rel="shortcut icon" href="http://www.lianshang.com/resources/images/favicon.ico"/>
    <link rel="icon" href="http://www.lianshang.com/resources/images/favicon.ico" type="image/x-icon"/>
    <script>

        window.LG = {};

        LG.me = {"userName": "${user.username!""}", "trueName": "${user.truename!""}", "userId": "${user.id!0}"};
        LG.appConfig = {
            "staticUrl": "${BASEPATH}",
            "baseAppUrl": "${APPBASEURL}"
        };
    </script>
</head>
...
<!-- END HEAD -->
    <#if (location=='login')>
    <body class=" login">
        <@utils.beginMainWrap location=location  mainWrap=mainWrap/>
        <#nested>
        <@utils.endMainWrap location=location mainWrap=mainWrap />
    <!-- BEGIN COPYRIGHT -->
    <div class="copyright"> ${copyright} </div>
    <!-- END COPYRIGHT -->
    <#else>
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white ${bodyAdditionCss}">
    ...
    <div class="page-header navbar navbar-fixed-top">
        ...
        <div class="page-header-inner ">
            ...
            <div class="page-logo">
                <a href="${APPBASEURL}">
                    <img src="${APPBASEURL}/assets/pages/img/logo.png" alt="logo" class="logo-default"/> </a>
        ...
        <#--</form>-->
            ...
            <#if location!='authfail' &&  location!='changepassword'>
                                        ...
                                        <li>
                                            <a href="javascript:;">
                                                <span class="time">just now</span>
                                                        <span class="details">
                                                   c         <span class="label label-sm label-icon label-success">
                        ...
                        <li class="dropdown dropdown-user">
                            <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
                               data-close-others="true">
                                ...
                                <span class="username username-hide-on-mobile"> ${user.truename!"用户"} </span>
                            ...
                            <ul class="sub-menu">
                                <li class="nav-item  ">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="nav-item ">
                                            <a href="table_bootstrap_master.html" class="nav-link "> Bootstrap
                                                Table </a>
                                        </li>
                                    </ul>
                                </li>
    ...
    <div class="page-footer">
        <div class="page-footer-inner"> ${copyright}
            <a href="http://www.guaishushu.com?from=mmbabyadmin"
               title="怪蜀黍母婴网官网" target="_blank">访问官网</a>
        </div>
...
<!-- END CORE PLUGINS -->
<!-- BEGIN PAGE LEVEL PLUGINS -->
    <@utils.scripts base=BASEPATH version=VERSION scripts=extraLoadJSPlugin isPlugin=true/>
<!-- END PAGE LEVEL PLUGINS -->
<!-- BEGIN THEME GLOBAL SCRIPTS -->
<script src="${BASEPATH}/assets/global/scripts/app.min.js" type="text/javascript"></script>
<!-- END THEME GLOBAL SCRIPTS -->
<!-- BEGIN PAGE LEVEL SCRIPTS -->
    <@utils.scripts base=BASEPATH version=VERSION scripts=extraLoadJS isPlugin=false/>
...
<input type="hidden" data-version="${context.clientVersion}" data-env="${context.runEnv}">
